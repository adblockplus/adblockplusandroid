...
{
    char filename[] = "/data/data/org.adblockplus.android/defout";
    char script[] = "/data/data/org.adblockplus.android/script";
    pid_t pid;
...
static const char *classPathName = "org/adblockplus/android/Exec";
